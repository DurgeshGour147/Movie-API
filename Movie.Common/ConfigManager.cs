...
namespace Movie_store.Common
{
    public class ConfigManager
    {
        ...
        public string MovieStoreConnectionString => Configuration.GetConnectionString(IsStaging ? AppSettingConstant.CONNECTION_STRING_STAGING : AppSettingConstant.CONNECTION_STRING_PRODUCTION);
